...
if __name__ == "__main__":
    ...
    face_image = load_image("/data2/jeesoo/FFHQ/00000/00000.png")
    ...
    pose_image = load_image("/data2/jiyoon/InstantID/test/pose/p2.jpeg")
    ...
    image.save('/data2/jiyoon/InstantID/test/results/infer_full/p2/a_baby_with_a_pink_bow.jpg')